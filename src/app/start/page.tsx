  ...
  return (
    <section className="py-16 sm:py-24 bg-bg">
      <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <Link
          href="/score"
          className="mt-8 inline-flex items-center justify-center rounded-lg bg-accent px-8 py-4 text-lg font-semibold text-white hover:bg-accent-hover transition-colors"
        >
